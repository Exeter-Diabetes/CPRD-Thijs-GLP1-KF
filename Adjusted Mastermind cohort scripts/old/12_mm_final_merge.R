...
all_diabetes_drug_periods <- all_diabetes %>%
  ...
  analysis$cached("20250312_all_1stinstance_interim_1", indexes=c("patid", "dstartdate", "drug_class", "drug_substance"))
...
all_diabetes_1stinstance <- all_diabetes_1stinstance %>%
  ...
  analysis$cached("20250312_all_1stinstance_interim_2", indexes=c("patid", "dstartdate", "drug_substance"))
...
all_diabetes_1stinstance <- all_diabetes_1stinstance %>%
  ...
  analysis$cached("20250312_all_1stinstance_interim_3", indexes=c("patid", "dstartdate", "drug_substance"))
...
all_diabetes_1stinstance <- all_diabetes_1stinstance %>%
  ...
  analysis$cached("20250312_all_1stinstance_interim_4", indexes=c("patid", "dstartdate", "drug_class"))
...
# 
#   analysis$cached("2025-03-12_all_1stinstance_interim_q1"), indexes=c("patid", "dstartdate", "drug_substance"))
# 
# 
# 
...
# 
#   analysis$cached("2025-03-12_all_1stinstance_interim_q2"), indexes=c("patid", "dstartdate", "drug_substance"))
# 
# 
# 
# qscores <- qscores %>%
...
# 
#   analysis$cached("2025-03-12_all_1stinstance_interim_q3"), indexes=c("patid", "dstartdate", "drug_substance"))
# 
# 
# 
# qscores <- qscores %>%
...
# 
#   analysis$cached("2025-03-12_all_1stinstance_interim_q4"), indexes=c("patid", "dstartdate", "drug_substance"))
# 
# 
# 
...
#   analysis$cached("2025-03-12_all_1stinstance_interim_5"), indexes=c("patid", "dstartdate", "drug_substance"))
...
#   
#   analysis$cached("2025-03-12_all_1stinstance_interim_ckd1"), indexes=c("patid", "dstartdate", "drugclass"))
# 
# 
# 
...
#   
#   analysis$cached("2025-03-12_all_1stinstance_interim_ckd2"), indexes=c("patid", "dstartdate", "drugclass"))
# 
# 
# 
...
#   
#   analysis$cached("2025-03-12_all_1stinstance_interim_ckd3"), indexes=c("patid", "dstartdate", "drugclass"))
# 
# 
# 
# ckdpc_scores <- ckdpc_scores %>%
...
#   
#   analysis$cached("2025-03-12_all_1stinstance_interim_ckd4"), indexes=c("patid", "dstartdate", "drugclass"))
# 
# 
# 
# ## Join with main dataset
...
#   analysis$cached("2025-03-12_all_diabetes_1stinstance"), indexes=c("patid", "dstartdate", "drugclass"))
...
t2d_1stinstance <- all_diabetes_1stinstance %>% filter(diabetes_type=="type 2") %>%
  analysis$cached("20250312_t2d_1stinstance", indexes=c("patid", "dstartdate", "drug_class", "drug_substance"))
...
save(t2d_1stinstance_a, file="2025-03-12_t2d_1stinstance_a.Rda")
...
save(t2d_1stinstance_b, file="2025-03-12_t2d_1stinstance_b.Rda")
...
t2d_all_drug_periods <- all_diabetes %>%
  ...
  select(patid) %>%
  inner_join(drug_start_stop, by="patid") %>%
  analysis$cached("20250312_t2d_all_drug_periods")


t2d_all_drug_periods <- collect(t2d_all_drug_periods %>% mutate(patid=as.character(patid)))

save(t2d_all_drug_periods, file="2025-03-12_t2d_all_drug_periods.Rda")